...
const News = () => {
    ...
    useEffect(() => {
        fetch('https://gnews.io/api/v4/search?q=motorcycle&country=us&apikey=4843d1484e82cc8c3d67ec345aff19d2&max=20')
    ...
    return (
        <>
        <NewsNavbar/>
        <div className="news-container-fluid px-3" style={{ backgroundColor: "#E2E2E5" }}>
            {loading ? ( 
